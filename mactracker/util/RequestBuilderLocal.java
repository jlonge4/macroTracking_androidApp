package com.jldevtech.mactracker.util;
 ...
 * @version 2.0
 */
public class RequestBuilderLocal {
     ...
     */
    public RequestBuilderLocal(String APP_KEY, String APP_SECRET) {
     ...
     *
     * @param barcode			search foodId for querying food items
